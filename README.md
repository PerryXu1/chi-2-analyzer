...
The physical dataset consists of high-frequency oscilloscope waveforms captured from an electro-optic phase modulator setup. The data is structurally shaped as a **dominant sine wave** carrying a high-frequency **phase modulation oscillation** on top of it. 
