...
class Simulator:
    ...
    def modulated_sine(self, *, Vpp: float = 0.26, phase_mod_cycles: float = 2.9, phase_mod_frequency: float = 150,
        ...
        phase_change = ((2 * np.pi * fiber_length * chi2 * field_adjustment_factor * ac_voltage) / (wavelength * core_index * eff_distance)) * np.cos(2 * np.pi * ac_frequency * (self.time - t_offset))
